...
<html lang="en">
	<head>
		...
		<title>
			Welcome!! This page cannot be accessed by anonymous users
		</title>
		<meta name="author" content="kim sia"><!-- Date: 2012-04-30 -->
	</head>
	<body>
		<h1>Welcome!! This page cannot be accessed by anonymous users</h1>
		<?php if ($loggedIn) : ?>
		<h2>Logged in as <?php echo $user; ?> | <a href="logout.php">Logout</a></h2>
		<?php endif; ?>
		<a href="public_home.php">Publicly accessible page</a>
	</body>
</html>
