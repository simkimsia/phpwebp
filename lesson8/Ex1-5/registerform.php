						...
						<fieldset>
							...
							<p>
								...
								<b>First choice in Diploma:</b> <select size="1" name="diploma">
									...
									<option value="Diploma in Mobile and Wireless Computing" <?php if ($diploma == 'Diploma in Mobile and Wireless Computing') echo 'selected'; ?>>
										Diploma in Mobile and Wireless Computing
									</option>
									<option value="Diploma in Financial Business Informatics" <?php if ($diploma == 'Diploma in Financial Business Informatics') echo 'selected'; ?>>
										Diploma in Financial Business Informatics
									</option>
									<option value="Diploma in Cyber and Digital Security" <?php if ($diploma == 'Diploma in Cyber and Digital Security') echo 'selected'; ?>>
										Diploma in Cyber and Digital Security
									</option>
									<option value="Diploma in Game and Entertainment Technology" <?php if ($diploma == 'Diploma in Game and Entertainment Technology') echo 'selected'; ?>>
